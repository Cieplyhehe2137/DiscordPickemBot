  ...
  return (
    ...
    >
      ...
      {nextUnpredictedMatch && (
        <div className="mt-6 rounded-2xl border border-violet-400/20 bg-violet-500/10 p-5">
          ...
          <p className="mt-2 text-white/50">
            {formatPhaseLabel(nextUnpredictedMatch.phase)} • BO
            {nextUnpredictedMatch.best_of || 3}
          </p>
      ...
      <div className="mt-6 flex flex-wrap gap-3">
        ...
        >
          {nextUnpredictedMatch ? "Następny mecz" : "Wszystkie typy gotowe"}
        </button>
      </div>
