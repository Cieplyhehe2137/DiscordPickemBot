  ...
  return (
    <footer className="mt-20 border-t border-white/10 pt-10">
      <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
        <div>
          <p className="text-xl font-black">Platforma Pick&apos;Em</p>

          <p className="mt-2 max-w-md text-sm text-white/40">
            Platforma Pick&apos;Em dla społeczności esportowej z meczami na
            żywo, rankingami i publicznymi stronami wydarzeń.
          </p>
        </div>
