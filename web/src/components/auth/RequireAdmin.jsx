...
function hasAdminPermission(user) {
  ...
  return (user.guilds || []).some((g) => {
    try {
      return (
        (BigInt(g.permissions) & ADMINISTRATOR_PERMISSION) ===
    ...
    return (
      <Screen>
        ...
        <p className="mt-2 text-sm text-white/50">
          Ten obszar jest dostępny tylko dla administratorów serwerów Discord
          korzystających z tego bota.
        </p>
    ...
    return (
      <Screen>
        ...
        <p className="mt-2 text-sm text-white/50">
          ...
          , ale to konto nie ma uprawnień Administratora na żadnym serwerze
          korzystającym z tego bota.
        </p>
