  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-zinc-950 px-6 py-10 pb-28 text-white xl:pb-10">
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        ...
        <h1 className="mt-3 text-4xl font-black md:text-6xl">{guild.name}</h1>

        <p className="mt-4 max-w-2xl text-white/50">
          Śledź aktywne wydarzenia Pick&apos;Em, mecze na żywo i rankingi
          społeczności.
        </p>
            ...
            {(data.top_players || []).map((player, index) => (
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-black">{player.user_id}</h3>

                    <p className="text-sm text-white/40">Gracz społeczności</p>
                  </div>
                </div>
