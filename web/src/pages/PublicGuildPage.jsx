    ...
    return (
        <div className="min-h-screen bg-zinc-950 px-6 py-10 text-white">
            <div className="mx-auto max-w-7xl">
                ...
                <a
                    href="/public"
                    className="text-sm font-black uppercase tracking-[0.2em] text-violet-300 transition hover:text-violet-200"
                >
                    ← Communities
                </a>

                <p className="mt-8 text-sm uppercase tracking-[0.25em] text-violet-300">
                    Community Hub
                </p>
                ...
                <div className="mt-6 flex flex-wrap gap-4">
                    ...
                    {featuredEvent && (
                        <a
                            href={`/public/${featuredEvent.slug}`}
