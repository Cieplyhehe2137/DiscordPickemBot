      ...
      <div className="flex min-h-[60vh] items-center justify-center px-6">
        <div className="w-full max-w-md rounded-2xl border border-white/10 bg-white/5 p-8 text-center">
          ...
          <p className="mt-2 text-sm text-white/50">
            Twoje konto nie ma uprawnień Administratora na serwerze{" "}
            <span className="font-bold text-white/80">{guildId}</span>.
          </p>
  ...
  return (
    <div className="px-6 py-10">
      <div className="mx-auto max-w-7xl">
        ...
        <h1 className="mt-3 text-5xl font-black">{guild?.name || guildId}</h1>
        ...
        <div className="mt-10 flex flex-wrap items-center justify-between gap-4">
          <div>
            <h2 className="text-3xl font-black">Eventy</h2>
        ...
        {!loading && filteredEvents.length === 0 && (
          <div className="mt-10">
            <EmptyState
              ...
              title={
                events.length === 0
                  ? "Nie znaleziono eventów dla tego serwera"
                  : "Żaden event nie pasuje do wybranych filtrów"
              }
              description={
                events.length === 0
                  ? "Utwórz swój pierwszy event powyżej, aby zacząć."
                  : "Spróbuj innego filtra statusu lub frazy wyszukiwania."
              }
            />
          </div>
        )}
          ...
          {filteredEvents.map((event, index) => (
            ...
            >
              ...
              <div className="mt-6 grid grid-cols-3 gap-3">
                ...
                <MiniStat label="Typy" value={event.predictions_count || 0} />

                <MiniStat label="Mecze" value={event.matches_count || 0} />
              </div>
              ...
              <div className="mt-6 rounded-2xl border border-white/10 bg-black/20 p-4">
                ...
                <p className="mt-4 text-sm text-white/40">Utworzono</p>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 px-6 backdrop-blur-sm">
          <div className="w-full max-w-xl rounded-[2rem] border border-white/10 bg-zinc-950 p-8 text-white shadow-2xl">
            ...
            <div className="mt-8 grid gap-5">
              ...
              <div>
                <label className="text-sm font-bold text-white/60">Slug</label>
