      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        ...
        <div className="mt-6 rounded-[2rem] border border-white/10 bg-white/5 p-6">
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-5">
            ...
            <ProfileStat
              title="Double Elim"
              value={profile.doubleelim_points}
            />
        ...
        <div className="mt-6 rounded-[2rem] border border-white/10 bg-white/5 p-6">
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-4">
            <ProfileStat title="Skuteczność" value={`${profile.accuracy}%`} />
            ...
            <ProfileStat title="Dokładne wyniki" value={profile.exact_scores} />
          </div>
        </div>
              ...
              >
                <div className="flex flex-wrap items-center justify-between gap-6">
                  ...
                  <div className="grid grid-cols-2 gap-3 md:grid-cols-5">
                    ...
                    <ProfileStat
                      title="Playoffs"
                      value={event.playoffs_points}
                    />
                    <ProfileStat title="Play-In" value={event.playin_points} />
                    <ProfileStat
                      title="Double"
                      value={event.doubleelim_points}
                    />
                  </div>
                </div>
              </Link>
        ...
        <SwissPickemHistory swissPicks={data.swiss_picks || []} />
          ...
          <div className="flex flex-wrap items-center justify-between gap-6">
            <div>
              ...
              <p className="mt-2 text-white/50">
                {correctWinners} trafionych zwycięzców • {exactScores}{" "}
                dokładnych wyników • {finishedPredictions} zakończonych typów
              </p>
            </div>
