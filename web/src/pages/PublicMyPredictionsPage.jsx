...
export default function PublicMyPredictionsPage() {
  ...
  if (!isLoggedIn) {
    return (
      <PageShell>
        <h1 className="text-4xl font-black md:text-6xl">Wymagane logowanie</h1>
  ...
  return (
    <PageShell>
      ...
      <h1 className="mt-3 text-4xl font-black md:text-6xl">Moje typy</h1>
          ...
          <div className="flex flex-wrap items-center justify-between gap-6">
            <div>
              ...
              <p className="mt-2 text-white/50">
                {correctWinnerCount} trafionych zwycięzców • {exactScoreCount}{" "}
                dokładnych wyników
              </p>
            </div>
            ...
            <div className="flex items-center gap-4">
              <div className="rounded-2xl border border-green-400/20 bg-green-500/10 px-5 py-4">
                <p className="text-sm text-green-300">Trafione typy</p>
              ...
              <div className="rounded-2xl border border-yellow-400/20 bg-yellow-500/10 px-5 py-4">
                <p className="text-sm text-yellow-300">Dokładne trafienia</p>
        ...
        <div className="mt-6 grid gap-4">
                ...
                <div>
                  ...
                  <p className="mt-2 text-white/50">
                    ...
                    {prediction.match_status === "FINAL" && (
                      <div
                        className={`mt-3 inline-flex rounded-full px-3 py-1 text-xs font-black uppercase tracking-[0.15em] ${
                  ...
                  {prediction.match_status === "FINAL" && (
                    <p className="mt-2 text-white/50">
                      Wynik: {prediction.actual_score_a}:
                      {prediction.actual_score_b}
                    </p>
                  )}
          ...
          {sortedPredictions.length === 0 && (
            <div className="rounded-2xl border border-white/10 bg-black/30 p-6">
              <p className="text-xl font-black">Nie znaleziono typów</p>
