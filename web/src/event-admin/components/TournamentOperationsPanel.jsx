  ...
  return (
    <section className="mt-10 rounded-[2rem] border border-amber-400/20 bg-amber-500/5 p-8">
      ...
      <p className="mt-2 text-white/50">
        To są odpowiedniki operatorskich akcji z Discorda.
        Restore i cleanup mają dodatkowe potwierdzenia.
      </p>
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-2">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              ...
              <p className="mt-1 text-sm text-white/50">
                Tworzy SQL tylko dla danych tego serwera tam,
                gdzie tabela ma guild_id. Trzymanych jest
                10 najnowszych — starsze kasują się same.
              </p>
            </div>
            ...
            <button
              ...
              disabled={
                operations.backupActionLoading ||
                !event?.guild_id
              }
        ...
        <div className="rounded-2xl border border-white/10 bg-black/30 p-5">
          ...
          <p className="mt-1 text-sm text-white/50">
            Tworzy XLSX do archiwum, zamyka aktywne panele
            i oznacza event jako zakończony lub archiwalny.
          </p>
          ...
          <input
            ...
            onChange={(eventChange) =>
              operations.setArchiveName(
                eventChange.target.value
              )
            }
            placeholder={
              event?.slug || 'nazwa_archiwum'
            }
          ...
          <label className="mt-5 flex cursor-pointer items-start gap-3 rounded-xl border border-red-400/20 bg-red-500/5 p-4 text-sm text-white/70">
            <input
              type="checkbox"
              checked={
                operations.cleanupAfterArchive
              }
              onChange={(eventChange) =>
                operations.setCleanupAfterArchive(
            ...
            <span>
              Po archiwizacji wyczyść dane operacyjne
              tego eventu. Zostaw wyłączone, jeśli chcesz
              tylko zamknąć i zarchiwizować event bez
