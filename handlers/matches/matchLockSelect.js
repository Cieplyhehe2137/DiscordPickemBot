...
module.exports = async function matchLockSelect(
  interaction
) {
  try {
      ...
      async ({ pool, guildId }) => {
        ...
        const embed =
          new EmbedBuilder()
            ...
            .setDescription(
              'Wybierz sposób działania blokady.'
            );
        ...
        const row =
          new ActionRowBuilder()
            .addComponents(
              ...
              new ButtonBuilder()
                .setCustomId(
                  `match_lock_set:${match.id}:unlock`
                )
                .setLabel('Odblokuj')
                .setEmoji('🔓')
                .setStyle(
