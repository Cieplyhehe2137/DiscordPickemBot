  ...
  switch (customId) {
    case "panel:open:results":
      return new StringSelectMenuBuilder()
        ...
        .addOptions(
          {
            label: "Eksport klasyfikacji",
            value: "results:export",
            emoji: "📁",
          },
    ...
    case "panel:open:danger":
      return new StringSelectMenuBuilder()
        ...
        .addOptions(
          {
            label: "Wyczyść typy userów",
            value: "danger:clearPicks",
            emoji: "✏️",
          },
          {
            label: "Wyczyść tylko oficjalne wyniki",
            value: "danger:clearOfficial",
            emoji: "🗑️",
          },
          { label: "Pełny reset", value: "danger:fullReset", emoji: "💣" },
          {
            label: "Usuń ustawione mecze (faza)",
            value: "danger:clearMatches",
            emoji: "🧹",
          },
        );
  ...
  try {
    ...
    if (interaction.isStringSelectMenu()) {
      ...
      if (value === "results:swiss1") {
        return require("../swiss/openSwissResultsDropdown")(
          interaction,
          "stage1",
        );
      }
      ...
      if (value === "results:double") {
        return require("../doubleelim/openDoubleElimResultsDropdown")(
          interaction,
        );
      }
